...
HD_PWD='C:/Users/artha/Documents/GitHub/Station-Meteo-VHDL/Etude/Modulo_4/Modulo_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compteur_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compteur_4.tcl
